    ...
    <div className="mt-2">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-0 md:border md:border-gray-300 md:rounded-xl overflow-hidden">
        <div className="bg-white border rounded-xl p-4 space-y-4 border-gray-300
          ...
          <h3 className="text-center border-b border-gray-300 rounded-t-xl md:rounded-none font-semibold text-gray-700 bg-gray-100 p-4 -m-4 mb-4 md:-m-6 md:mb-6">
            IN-CLINIC
          </h3>
        ...
        <div className="bg-white border border-gray-300 rounded-xl p-4 space-y-4
          ...
          <h3 className="text-center border-b border-gray-300 font-semibold rounded-t-xl  md:rounded-none text-gray-700 bg-gray-100 p-4 -m-4 mb-4 md:-m-6 md:mb-6">
            HOME VISIT
          </h3>
